...
Runtime feeds fetch source metadata on demand from user-provided post links. Local uploads use browser object URLs for the current session only and are revoked on cleanup.
