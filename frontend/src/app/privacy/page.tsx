  ...
  return (
    <LegalPage
      ...
      sections={[
        ...
        {
          title: "3. Reddit And Third-Party Media Data",
          paragraphs: [
        ...
        {
          title: "5. Automatically Collected And Operational Data",
          paragraphs: [
        ...
        },
        {
          ...
          paragraphs: ["Scrollable uses information to:"],
          bullets: [
        ...
        {
          title: "9. Children And NSFW Content",
          paragraphs: [
